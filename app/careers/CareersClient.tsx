  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cr-perks-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; }
        ...
        .cr-perk { background: #fff; border: 1px solid var(--line-strong); border-radius: 10px; padding: 28px 24px; }
        .cr-perk-icon { width: 40px; height: 40px; border-radius: 8px; background: var(--paper-3); border: 1px solid var(--line-strong); display: flex; align-items: center; justify-content: center; color: var(--ink); margin-bottom: 16px; }
        .cr-perk-title { font-size: 15px; font-weight: 600; color: var(--ink); letter-spacing: -.015em; margin-bottom: 8px; }
        .cr-perk-desc { font-size: 13px; color: var(--muted); line-height: 1.6; }

        .cr-roles-section { padding: 96px 0 140px; background: #fff; }
        .cr-roles-list { display: flex; flex-direction: column; border: 1px solid var(--line-strong); border-radius: 10px; overflow: hidden; margin: 40px 0 72px; }
        ...
        .cr-open-app { background: var(--paper-2); border: 1px solid var(--line-strong); border-radius: 10px; padding: 44px; display: flex; flex-direction: column; align-items: flex-start; gap: 16px; }
        .cr-open-h { font-size: clamp(22px, 2.5vw, 36px); font-weight: 600; letter-spacing: -.03em; color: var(--ink); }
        .cr-open-p { font-size: 15px; color: var(--muted); line-height: 1.6; max-width: 52ch; }
        .cr-btn-primary { background: #1B1A68; color: #fff; font-weight: 600; padding: 12px 22px; border-radius: 8px; font-size: 14px; display: inline-flex; align-items: center; gap: 9px; transition: background .2s ease; }
        .cr-btn-primary:hover { background: #14136B; }
      `}</style>
    </>
  );
}
