  ...
  return (
    <>
      ...
      <style>{`
        ...
        .pp-accent { color: #2D2BE0; font-family: var(--font-instrument), serif; font-style: italic; font-weight: 400; }
        ...
        .pp-model-num { font-family: var(--font-instrument), serif; font-style: italic; font-weight: 400; font-size: 15px; color: rgba(27,26,104,.42); margin-bottom: 20px; }
